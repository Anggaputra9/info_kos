...
<head>
    ...
    <style>
        ...
        /* Mengubah warna background dropdown item saat diaktifkan (klik) */
        ...
        .dropdown-menu .dropdown-item:focus {
            ...
            /* Menghilangkan efek shadow yang biasanya muncul */
        }

        /* Mengubah warna background dropdown item saat mouse hover */
        ...
        /* Mengubah warna default dropdown item */
        .dropdown-menu .dropdown-item {
            background-color: transparent;
            /* Atur background menjadi transparan */
            color: #000;
            /* Setel warna teks default */
        }
    </style>
</head>
...
<body>
    ...
    <section class="hero d-flex align-items-center text-center" data-aos="fade-up" data-aos-duration="1000">
        <div class="container mt-4 mb-5">
            <img src="../image/logonavbar_MyKost.png" alt="logo" style="max-height: 200px;" class="mt-5 mb-5">
            <h1>Selamat Datang <span style="font-weight: 650;">Admin</span> <span style="color: blue; font-weight:700;">My</span><span style="color: black; font-weight:700;">Kost</span>, <br>Jadilah Info Kos terbaik dari yang terbaik!</h1>
        </div>
    </section>

    <section class="hero d-flex flex-column align-items-center text-center py-4" data-aos="fade-up" data-aos-duration="1000">
        <div class="header-container mb-4">
            <h2 style="margin: 0;">Menunggu Persetujuan</h2>
        </div>
        <div class="container">
    ...
    <section class="container py-5">
        <div class="header-container" style="display:flex; align-items: center; justify-content: center; ">
            ...
            <div class="nav-item dropdown">
                <button class="btn btn-primary" style="margin-left: 15px; background-color:#15133C" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <a href="<?php echo $row['link_map']; ?>" target="_blank" class="btn btn-primary" style="background-color: #15133C;">Location</a>
                                        <!-- Tombol untuk membuka modal -->
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#ulasanModal<?php echo $row['id_kos']; ?>" style="background-color: #15133C;">review</button>
                                        <a href="https://wa.me/<?php echo $row['whatsapp']; ?>" target="_blank" class="btn btn-primary" style="background-color: #15133C;">Reservasi</a>
                                    </div>
                                </div>
                            </div>
                        </div>
