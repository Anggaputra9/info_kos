...
<section id="daftar-kos" class="container py-5">
    <form class="d-flex mx-auto mb-5" style="max-width: 600px" data-aos="fade-up" data-aos-duration="1000" method="GET" action="">
        ...
        <button class="btn btn-primary" type="submit" style="background-color:#86bbd1; padding: 10px 16px; min-width: 80px;">
            Cari!
        </button>
    </form>
    ...
    <div class="row">
        <div class="container mt-5">
            <div class="row">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <h5>Tambah Ulasan</h5>
                                    <form action="../admin/simpanUlasan.php" method="POST">
                                        <div class="mb-3">
                ...
                ?>
                    <button type="button" onclick="window.location.href='../admin/tambahKos2.php';" style="padding: 10px 20px; font-size: 16px; cursor: pointer; background-color:#86bbd1;color:white;">Add</button>
