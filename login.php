            ...
            <div class="row justify-content-center" data-aos="fade-up" data-aos-duration="1000">
                <div class="col-md-4">
                    ...
                    <form action="login.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary w-100" style="background-color: #86bbd1;">Masuk</button>
                    </form>
                    <p class="text-center mt-3">Belum punya akun? <a href="signup.php" style="color: #86bbd1;">Daftar di sini</a></p>
                </div>
            </div>
        </div>
    </section>
