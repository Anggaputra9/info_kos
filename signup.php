            ...
            <div class="row justify-content-center">
                <div class="col-md-5" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <form action="signup.php" method="POST">
                        ...
                        <button type="submit" class="btn btn-primary w-100" style="background-color: #86bbd1;">Daftar</button>
                    </form>
                    <p class="text-center mt-3">Sudah punya akun? <a href="login.php" style="color: #86bbd1;">Login di sini</a></p>
                </div>
            </div>
        </div>
    </section>
